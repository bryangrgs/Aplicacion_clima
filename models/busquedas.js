...
class Busquedas{
    ...
    //metodo para los parametros de la ciudad
    get paramsMapbox(){
        return{
    ...
    async ciudad( lugar= ''){
        try {
            ...
            const intance = axios.create({
                // ? todo lo que venga despues de este signo de interrogacion en la (peticion) url son parametros
...
leerDB(){
    ...
    this,this.historial= data.historial;
